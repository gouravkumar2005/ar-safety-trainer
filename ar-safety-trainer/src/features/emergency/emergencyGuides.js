...
// other module in the app: it has no .glb (see app/routes.js), and the
// entry point is voice-triaged (platform/voiceInput.js) or a manual grid
// (emergency/hubScreen.js), not a locked/passed gate.
//
...
// only after that is chosen may a camera assist with WHERE (emergency/cprCameraScreen.js's
