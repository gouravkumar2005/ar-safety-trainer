...
export const en = {
  ...
  loginTitle: 'Log in',
  loginSubtitle: 'Use your work ID or registered mobile number.',
  ...
  loginEmergencyNote: '🚨 In an emergency? Tap here or the red button at the top — no login needed.',
  pleaseWait: 'Please wait…',
  retryBtn: 'Try again',

  registerTitle: 'Create an account',
  registerSubtitle: 'Your details appear on your safety certificates.',
  roleLabel: 'I am a',
  ...
  logoutBtn: 'Log out',
  certFromProfileNote: 'These details come from your profile. To change them, open 👤 My profile.',
