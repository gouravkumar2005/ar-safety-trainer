...
export const hi = {
  ...
  arHintScan: 'फ़र्श ढूँढने के लिए फ़ोन धीरे-धीरे घुमाएँ',
  arHintTap: 'फ़ोन फ़र्श की ओर करें। मॉडल सफ़ेद गोले पर आएगा।',
  arHintPlaced: 'खींचकर हिलाएँ · चुटकी से छोटा-बड़ा करें · घुमाकर मोड़ें',
