...
export const hi = {
  ...
  meshTitle: 'ऑफ़लाइन नेटवर्क',
  meshSubtitle: 'फ़ोन से फ़ोन · बिना इंटरनेट',
  meshWebOnlyTitle: 'सिर्फ़ Android ऐप में',
  meshWebOnlyBody: 'वेबसाइट बैकग्राउंड में ब्लूटूथ इस्तेमाल नहीं कर सकती। फ़ोन से फ़ोन रिकॉर्ड भेजने के लिए ऐप इंस्टॉल करें।',
  meshTurnOn: 'चालू करें',
  meshTurnOff: 'बंद करें',
  meshOff: 'बंद',
  meshRoleAdmin: 'संग्रहकर्ता (एडमिन फ़ोन)',
  meshRoleNode: 'कर्मचारी फ़ोन',
  meshNearby: 'पास के फ़ोन',
  meshHops: 'एडमिन तक हॉप',
  meshWaiting: 'भेजने बाकी',
  meshDelivered: 'पहुँच गए',
  meshRelaying: 'दूसरों के लिए ले जा रहे',
  meshReceived: 'प्राप्त कर्मचारी',
  meshNoRoute: 'अभी रास्ता नहीं',
  meshAdmin: 'एडमिन',
  meshHopsN: '{n} हॉप',
  meshNoPeers: 'पास में कोई फ़ोन नहीं। ब्लूटूथ चालू करें और फ़ोन लगभग 10 मीटर के अंदर रखें।',
  meshInboxTitle: 'प्राप्त रिकॉर्ड',
  meshInboxEmpty: 'अभी कुछ नहीं मिला।',
  meshReceiving: 'मिल रहा है…',
  meshLiveTile: 'लाइव ऑफ़लाइन नेटवर्क',
}
