...
// file needs to change — home.js/arViewer.js/quiz.js/result.js all iterate
...
export const modules = [
  {
    ...
    // isPpePassed()/requiresPpeGate() below and main.js's router. It stays
    ...
    // arViewer.js's comment for how it's applied and why cameraTarget
    ...
    // ppeGallery.js) — a generic flag, not a hardcoded module-id check in
    // arViewer.js, so any future module with its own per-item models
    ...
    // hotspots, not that gallery. See tour.js.
    tourItemMode: true,
  ...
  },
  {
    ...
    // src/data/machineryItems.js / itemGalleries.js.
    hasItemGallery: true,
